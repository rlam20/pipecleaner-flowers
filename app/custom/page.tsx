      ...
      <div className="max-w-[1200px] mx-auto px-6 py-12"> {/* Reduced max-width from 1600px */}
        ...
        <div className="grid md:grid-cols-2 gap-8"> {/* Reduced gap from 10 to 8 */}
          ...
          >
            ...
            <div className="relative w-48 h-48 mb-6 rounded-full overflow-hidden shadow-inner border-4 border-stone-100 group-hover:border-rose-100 transition-colors">
              <Image 
                src="/IMG_5299.jpeg"
                alt="Custom Bouquet"
                fill
